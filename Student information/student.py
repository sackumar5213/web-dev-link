...
class studentClass:
    def __init__(self,root):
        ...
        txt_state=Entry(self.root,textvariable=self.var_state,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=120,y=220,width=160)

        lbl_city=Label(self.root,text="City",font=("goudy old style",15,'bold'),bg="white").place(x=285,y=220)
        txt_city=Entry(self.root,textvariable=self.var_city,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=335,y=220,width=120)

        lbl_pin=Label(self.root,text="Pin",font=("goudy old style",15,'bold'),bg="white").place(x=485,y=220)
        txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=530,y=220,width=150)
        ...
        txt_Name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=120,y=100,width=200)
        txt_Email=Entry(self.root,textvariable=self.var_Email,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=120,y=140,width=200)
        ...
        self.txt_address.place(x=120,y=260,width=560,height=100)

        #==========COlumn 2============
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style",15,'bold'),bg="white").place(x=340,y=60)
        lbl_contact=Label(self.root,text="Contact",font=("goudy old style",15,'bold'),bg="white").place(x=340,y=100)
        lbl_addmission=Label(self.root,text="Addmission",font=("goudy old style",15,'bold'),bg="white").place(x=340,y=140)
        lbl_course=Label(self.root,text="Course",font=("goudy old style",15,'bold'),bg="white").place(x=340,y=180)
