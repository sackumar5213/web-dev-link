...
class resultClass:
    def __init__(self,root):
        ...
        self.txt_student.place(x=300,y=100,width=200)
        self.txt_student.set("---Select---")

        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=510,y=100,width=120,height=28)

        txt_name=Entry(self.root,textvariable=self.var_name,font=("goudy old style",20,'bold'),bg="lightyellow",state='readonly').place(x=300,y=160,width=240)
        txt_course=Entry(self.root,textvariable=self.var_course,font=("goudy old style",20,'bold'),bg="lightyellow",state='readonly').place(x=300,y=220,width=240)
        txt_marks=Entry(self.root,textvariable=self.var_marks,font=("goudy old style",20,'bold'),bg="lightyellow").place(x=300,y=280,width=240)
        txt_full_marks=Entry(self.root,textvariable=self.var_full_marks,font=("goudy old style",20,'bold'),bg="lightyellow").place(x=300,y=340,width=240)
        ...
        self.lbl_bg=Label(self.root,image=self.bg_img).place(x=635,y=100)
...
#================================================================================================
    ...
    def add(self):
        ...
        try:
            ...
            messagebox.showerror("Error",f"Error due to the {str(ex)}")
